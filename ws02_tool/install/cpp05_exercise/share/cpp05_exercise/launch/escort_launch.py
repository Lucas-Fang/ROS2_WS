...
def generate_launch_description():
    ...
    # 3.发布所有乌龟🐢相对于世界的坐标变换
    turtle_world = Node(package="cpp05_exercise",executable="exer02_tf_broadcaster",name="turtle_world")
    ...
    # 4.监听坐标变换
    listen_escort_goal_back = Node(package="cpp05_exercise",executable="exer03_tf_listener",
                                   name="listen_escort_goal_back",
                                   parameters=[{"father_frame":LaunchConfiguration("turtle_back"),
                                                "child_frame":"escort_goal_back"}])
    listen_escort_goal_left = Node(package="cpp05_exercise",executable="exer03_tf_listener",
                                   name="listen_escort_goal_left",
                                   parameters=[{"father_frame":LaunchConfiguration("turtle_left"),
                                                "child_frame":"escort_goal_left"}])
    listen_escort_goal_right = Node(package="cpp05_exercise",executable="exer03_tf_listener",
                                   name="listen_escort_goal_right",
    ...
    return LaunchDescription([escort_back,escort_left,escort_right,
                              ...
                              turtle_world,left_world,right_world,back_world,
                              escort_goal_back,escort_goal_left,escort_goal_right,
                              listen_escort_goal_back,listen_escort_goal_left,listen_escort_goal_right])